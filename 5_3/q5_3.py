...
parser.add_argument('--gen_seq_len', type=int, default=35,
                    help='Generated Sequences Length')

parser.add_argument('--temperature', type=float, default=1,
                    help='Softmax temperature')

parser.add_argument('--n_sequences', type=int, default=10,
                    help='Number of generated sequences')
...
args = ExperimentArgs(base_folder)

args.seq_len = args_parse.gen_seq_len
args.batch_size = args_parse.n_sequences
...
for seq_idx in range(args_parse.n_sequences):
    for l in range(args_parse.gen_seq_len):
        if l == 0:
            print(f"{seq_idx})",id_2_word[init_words[0,seq_idx]],end=" ")
